"""Tests for agent_core.agent.approval.executor."""
...
from agent_core.agent.approval.executor import execute
...
async def test_execute_tool_call_dispatches_with_action_id():
    ...
    with patch(
        "agent_core.agent.approval.executor.tool_dispatcher.dispatch",
        new=dispatch_mock,
    ):

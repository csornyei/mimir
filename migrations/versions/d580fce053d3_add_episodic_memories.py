...
def upgrade() -> None:
    ...
    op.add_column('conversations', sa.Column('consolidated_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('conversations', sa.Column('consolidation_retries', sa.Integer(), server_default='0', nullable=False))
